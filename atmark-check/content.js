  ...
  var CONTENT = {
    ...
    self: {
      ...
      q2: {
        ...
        costLabel: '仕入れ・材料・外注費（年間・万円）',
        costLabelNote: '会計上は「売上原価」と呼ばれる数字です。',
        marginLabel: '粗利率（%）',
        toggleToPercent: '％で入力する（戻る）',
        toggleToCost: '粗利率が分からない場合 → 仕入れ・材料・外注費から出す',
    ...
    demo: {
      inputLabels: {
        ...
        industry: '業種',
        pref: '都道府県',
        cost: '仕入れ・材料・外注費（年間・万円）',
        costNote: '会計上は「売上原価」と呼ばれる数字です。',
        costToggleOn: '粗利率が分からない場合 → 仕入れ・材料・外注費から出す',
        costToggleOff: '％で入力する（戻る）',
      },

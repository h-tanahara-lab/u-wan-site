...
const CONTENT = {
  meta: {
    ...
    description: [
      ...
      '',
      'ある工務店さんは、見積書や工程表の作成に3日間、合間を見つけながら、合計9時間ほどかけていました。\nそれが今は、2時間ほどで終わる状態になっています。\n会社によって事情は違うので、同じになるとは限りません。\nただ、あなたの会社の場合はどうか、、、その視点で見てもらえたらと思います。',
      '',
  ...
  results: {
    A: {
      ...
      sections: [
        ...
        {
          title: 'まずはここから',
          text: '施工計画書・日報・お客様報告書、この3つをAIで作れる状態を体験してみませんか？\n3ヶ月あれば、十分その快適さを体感できます。\n\n僕が実際に見てきた中では、見積作成に3日9時間かけていた会社が、2時間ほどで終わるようになった例があります。\n全ての会社がこうなるとは限りませんが、あなたの会社が今どこにボトルネックを抱えているか、考えるヒントにはなると思います。',
        },
        {
          title: '次の一歩',
          isCta: true,
...
const App = {
  ...
  renderIntro() {
    ...
    paragraphs.forEach((block) => {
      ...
      // 一次事例パラグラフ（棚原確定コピー・イントロ用ハイブリッド版）に専用クラス付与
      else if (block.indexOf('ある工務店さんは、見積書や工程表の作成に') !== -1) {
        p.className = 'intro-copy__case-example';
      }
